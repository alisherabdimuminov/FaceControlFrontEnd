...
import { u as useHead, d as useToast, a as useRoute, n as navigateTo } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const loginWithPassport = async () => {
      let response = await $fetch(apify("passport"), {
        method: "POST",
        body: JSON.stringify({
...
//# sourceMappingURL=index-DYhPk7wF.mjs.map
